 ...
 * \file
 * \class      Docking
 * \brief      Classe principale de l'accostage
 ...
 * \brief      Classe principale de l'accostage
 *
 * \details    Cette classe gère l'action de l'accostage ainsi que
 *             l'algorithme de l'accostage.
 */
class Docking
{
protected:
...
public:
	Docking(std::string name)
		: m_as(m_nh, name, boost::bind(&Docking::executeCB, this, _1), false), m_actionName(name)

		, m_laserXPidKp(m_nh, "navigation/Docking/laserAsserv/xPid/Kp", 0.25)
		, m_laserXPidKi(m_nh, "navigation/Docking/laserAsserv/xPid/Ki", 0)
		, m_laserXPidKd(m_nh, "navigation/Docking/laserAsserv/xPid/Kd", 0)
		, m_laserXPidThreshold(m_nh, "navigation/Docking/laserAsserv/xPid/threshold", 0.01)
		, m_laserXPidNbSuccessNeeded(m_nh, "navigation/Docking/laserAsserv/xPid/nbSuccessNeeded", 3.0)

		, m_laserYPidKp(m_nh, "navigation/Docking/laserAsserv/yPid/Kp", 0.075)
		, m_laserYPidKi(m_nh, "navigation/Docking/laserAsserv/yPid/Ki", 0)
		, m_laserYPidKd(m_nh, "navigation/Docking/laserAsserv/yPid/Kd", 0)
		, m_laserYPidThreshold(m_nh, "navigation/Docking/laserAsserv/yPid/threshold", 0.003)
		, m_laserYPidNbSuccessNeeded(m_nh, "navigation/Docking/laserAsserv/yPid/nbSuccessNeeded", 3.0)

		, m_laserYawPidKp(m_nh, "navigation/Docking/laserAsserv/yawPid/Kp", 0.4)
		, m_laserYawPidKi(m_nh, "navigation/Docking/laserAsserv/yawPid/Ki", 0)
		, m_laserYawPidKd(m_nh, "navigation/Docking/laserAsserv/yawPid/Kd", 0)
		, m_laserYawPidThreshold(m_nh, "navigation/Docking/laserAsserv/yawPid/threshold", 0.003)
		, m_laserYawPidNbSuccessNeeded(m_nh, "navigation/Docking/laserAsserv/yawPid/nbSuccessNeeded", 3.0)

		, m_camXPidKp(m_nh, "navigation/Docking/camAsserv/xPid/Kp", 0.25)
		, m_camXPidKi(m_nh, "navigation/Docking/camAsserv/xPid/Ki", 0)
		, m_camXPidKd(m_nh, "navigation/Docking/camAsserv/xPid/Kd", 0)
		, m_camXPidThreshold(m_nh, "navigation/Docking/camAsserv/xPid/threshold", 0.01)
		, m_camXPidNbSuccessNeeded(m_nh, "navigation/Docking/camAsserv/xPid/nbSuccessNeeded", 3.0)

		, m_camYPidKp(m_nh, "navigation/Docking/camAsserv/yPid/Kp", 0.075)
		, m_camYPidKi(m_nh, "navigation/Docking/camAsserv/yPid/Ki", 0)
		, m_camYPidKd(m_nh, "navigation/Docking/camAsserv/yPid/Kd", 0)
		, m_camYPidThreshold(m_nh, "navigation/Docking/camAsserv/yPid/threshold", 0.003)
		, m_camYPidNbSuccessNeeded(m_nh, "navigation/Docking/camAsserv/yPid/nbSuccessNeeded", 3.0)

		, m_camYawPidKp(m_nh, "navigation/Docking/camAsserv/yawPid/Kp", 0.4)
		, m_camYawPidKi(m_nh, "navigation/Docking/camAsserv/yawPid/Ki", 0)
		, m_camYawPidKd(m_nh, "navigation/Docking/camAsserv/yawPid/Kd", 0)
		, m_camYawPidThreshold(m_nh, "navigation/Docking/camAsserv/yawPid/threshold", 0.003)
		, m_camYawPidNbSuccessNeeded(m_nh, "navigation/Docking/camAsserv/yawPid/nbSuccessNeeded", 3.0)
		...
		, m_mpsWidth(m_nh, "navigation/Docking/mps/width", 0.700)

		, m_yPoseS1(m_nh, "navigation/Docking/mps/targetPoses/yAxis/S1", -0.07)
		, m_yPoseS2(m_nh, "navigation/Docking/mps/targetPoses/yAxis/S2", -0.175)
		, m_yPoseS3(m_nh, "navigation/Docking/mps/targetPoses/yAxis/S3", -0.27)
		, m_yPoseLANE_RS(m_nh, "navigation/Docking/mps/targetPoses/yAxis/LANE_RS", -0.26)
		, m_yPoseLIGHT(m_nh, "navigation/Docking/mps/targetPoses/yAxis/LIGHT", 0.0)
		, m_yPoseLIGHT_OLD(m_nh, "navigation/Docking/mps/targetPoses/yAxis/LIGHT_OLD", 0.0)
		, m_yPoseCONVEYOR(m_nh, "navigation/Docking/mps/targetPoses/yAxis/CONVEYOR", 0.0225)

		, m_xPoseLIGHT_OLD(m_nh, "navigation/Docking/mps/targetPoses/xAxis/LIGHT_OLD", -0.36)
		, m_xPoseCONVEYOR(m_nh, "navigation/Docking/mps/targetPoses/xAxis/CONVEYOR", -0.16)

		, m_skipAsservCamera(m_nh, "navigation/Docking/skipAsservCamera", 0.0)
		, m_skipAsservLaser(m_nh, "navigation/Docking/skipAsservLaser", 0.0)
		...
		, m_remotelyControlled(false)
	{
		...
		// Subscribe
		m_control = m_nh.subscribe("navigation/dockingControl", 1, &Docking::controlCallback, this);

    m_ArTagSub = new ARTagSubscriber();

		// Start ActionServer
		m_as.registerPreemptCallback(boost::bind(&Docking::preemptCB, this));
		m_as.start();
	}
    ...
    std::string teamColorStr;
  	m_nh.param<std::string>("teamColor", teamColorStr, "cyan");
  	m_teamColor = (teamColorStr == "magenta")? MAGENTA: CYAN;
	...
	/**
	 * \brief      Affiche avec ROS_LOG le résultat de l'accostage. Ne fonctionne qu'en input
	 *
	 * \param      odom      The odom
