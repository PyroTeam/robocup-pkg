...
list<Tache> creation_liste_taches_prod(Produit produit,int debut_livraison,int fin_livraison) {
  ...
  case 1:
    ...
    liste.push_back(Tache("ChercherRing", produit.get_param(1),produit.get_nbr_ring(),debut_livraison,fin_livraison,90,1,false));
    liste.push_back(Tache("MettreCaps",   produit.get_param(2),produit.get_nbr_ring(),debut_livraison,fin_livraison,60,1,false));
    liste.push_back(Tache("ChercherCaps", produit.get_param(2),produit.get_nbr_ring(),debut_livraison,fin_livraison,60,1,false));
    liste.push_back(Tache("Livrer",       ""                  ,produit.get_nbr_ring(),debut_livraison,fin_livraison,30,1,false));
    break;
  case 2:
    ...
    liste.push_back(Tache("ChercherRing", produit.get_param(1),produit.get_nbr_ring(),debut_livraison,fin_livraison,120,1,false));
    ...
    liste.push_back(Tache("ChercherRing", produit.get_param(2),produit.get_nbr_ring(),debut_livraison,fin_livraison,120,1,false));
    liste.push_back(Tache("MettreCaps",   produit.get_param(3),produit.get_nbr_ring(),debut_livraison,fin_livraison,60,1,false));
    liste.push_back(Tache("ChercherCaps", produit.get_param(3),produit.get_nbr_ring(),debut_livraison,fin_livraison,60,1,false));
    liste.push_back(Tache("Livrer",       ""                  ,produit.get_nbr_ring(),debut_livraison,fin_livraison,30,1,false));
    break;
  case 3:
    ...
    liste.push_back(Tache("ChercherRing", produit.get_param(3),produit.get_nbr_ring(),debut_livraison,fin_livraison,120,1,false));
    liste.push_back(Tache("MettreCaps",   produit.get_param(4),produit.get_nbr_ring(),debut_livraison,fin_livraison,60,1,false));
    liste.push_back(Tache("ChercherCaps", produit.get_param(4),produit.get_nbr_ring(),debut_livraison,fin_livraison,60,1,false));
    liste.push_back(Tache("Livrer",       ""                  ,produit.get_nbr_ring(),debut_livraison,fin_livraison,30,1,false));
    break;
  default:
    exit(-1);
